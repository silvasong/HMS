				...
				<div class="col-md-10 ">
					<div class="row">
						<div class="col-md-9 article-block">
							<h3 style="margin-top: 0;">${news.newTitle}</h3>
						
							<div class="blog-tag-data">

								<div class="col-md-9 blog-tag-data-inner">
									<ul class="list-inline">
										<li><i class="fa fa-calendar"></i> <a href="javascript:;">
												${news.newTime} </a></li>
										<li><i class="fa fa-comments"></i> <a href="javascript:;">
												${news.newAuthor} </a></li>
										<li><i class="fa fa-comments"></i> <a href="javascript:;">
												${news.newType}</a></li>
									</ul>
							...
							<div class="row">
							    <hr>
								<div class="col-md-10 margin-top-10">${news.newContent}</div>

							</div>
						</div>
						
						<div class="col-md-3">
							<h2 class="no-top-space">相关新闻</h2>
							<ul class="margin-bottom-40">
							    <c:forEach var="map" items="${relatedNews}">
							    	<li><a href="?id=${map.key}">${map.value}</a></li>
							    </c:forEach>
