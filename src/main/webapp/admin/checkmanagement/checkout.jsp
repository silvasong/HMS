...
<div class="page-container">
	...
	<div class="page-content">
		<div class="container">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<div class="radio-list">
										...
										<input type="radio" name="status" value="1" checked/>入住 </label>
										<label class="radio-inline">
										<input type="radio" name="status" value="0"/>离店 </label>
			...
			<div class="modal fade" id="tf_modal" tabindex="-1" role="basic"
				aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">办理退房</h4>
						</div>
						<div class="modal-body">确认为选择订单办理退房？</div>
						<div class="modal-footer">
							<button type="button" class="btn blue" id="tf_com">退房</button>
						</div>
					</div>
					<!-- /.modal-content -->
				</div>
...
<script src="../../static/admin/js/check_out.js" type="text/javascript"></script>
<script>
      jQuery(document).ready(function() {    
      Metronic.init(); // init metronic core components
      Layout.init(); // init current layout
      Demo.init(); // init demo features
      CheckOut.init("<c:url value="/"/>");
      });
   </script>
<!-- END JAVASCRIPTS -->
</body>
