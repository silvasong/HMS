...
//            },
            ...
            "columns": [
               {"orderable": false },
	           { title: "ID",   data: "id" },
	           { title: "标题",   data: "newTitle" },
	          
	           { title: "来源",   data: "newAuthor" },
	           { title: "栏目",   data: "newType" },
	           { title: "时间",  data: "newTime"}	  
	         ],
	        "serverSide": true,
	        "serverMethod": "GET",
	        "ajaxSource": rootURI+"admin/new/new/new_list?rand="+Math.random()
       ...
       //打开删除对话框前判断是否已选择要删除的行
		...
		$('#delete_com').on('click', function (e) {
			$.ajax( {
             "dataType": 'json', 
             "type": "DELETE", 
             "url": rootURI+"admin/new/new/new_delete/"+selected.join(), 
	...
	var addNewType=function(){	
		$.ajax( {
         "dataType": 'json', 
         "type":'POST', 
         "url": rootURI+"admin/new/new/new_add?random="+Math.random(), 
  ...
  //编辑操作
	var editNewType=function(){		
		$.ajax( {
         "dataType": 'json', 
         "type":'POST', 
         "url": rootURI+"admin/new/new/new_edit?random="+Math.random(), 
