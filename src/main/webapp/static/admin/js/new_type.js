...
//            },
	        ...
	        "serverSide": true,
	        "serverMethod": "GET",
	        "ajaxSource": rootURI+"admin/new/newType/new_type_list?rand="+Math.random()
       ...
       //打开删除对话框前判断是否已选择要删除的行
		...
		$('#delete_com').on('click', function (e) {
			$.ajax( {
             "dataType": 'json', 
             "type": "DELETE", 
             "url": rootURI+"admin/new/newType/new_type_delete/"+selected.join(), 
		...
		$("#edit_btn").on("click",function(event){
			if(selected.length != 1){
	            ...
	            $("#edit_from input[name='name']").val(name);
	            $("#edit_from textarea[name='descr']").val(descr);
	...
	var addNewType=function(){		
		$.ajax( {
         "dataType": 'json', 
         "type":'POST', 
         "url": rootURI+"admin/new/newType/new_type_add?random="+Math.random(), 
  ...
  //编辑操作
	var editNewType=function(){		
		$.ajax( {
         "dataType": 'json', 
         "type":'POST', 
         "url": rootURI+"admin/new/newType/new_type_edit?random="+Math.random(), 
